...
const Layout = ({ onLogout, user }) => {
  ...
  const [showAllTransactions, setShowAllTransaction] = useState(false);
          ...
          <div className={styles.statCards.card}>
            <div className={styles.statCards.cardHeader}>
              ...
              <div className={styles.statCards.iconContainer("teal")}>
                <span className={styles.statCards.icon("teal")}>₹</span>
              </div>
            </div>
              ...
              <div className={styles.transactions.listContainer}>
                {displayedTransactions.map((transaction) => {
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-1 md:gap-4 lg:gap-3 min-w-0">
                        <div
                        ...
                        >
                          {CATEGORY_ICONS[category] || (
                            <span className={styles.transactions.icon}>₹</span>
                          )}
                        </div>
                ...
                {transactions.length === 0 ? (
                  ...
                  <div className={styles.transactions.viewAllContainer}>
                    <button
                      onClick={() =>
                        setShowAllTransaction(!showAllTransactions)
                      }
