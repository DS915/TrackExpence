...
const Signup = ({API_URL = "https://trackexpence-backend.onrender.com", onSignup}) => {
      ...
      <div className={signupStyles.cardContainer}>
        ...
        <div className={signupStyles.formContainer}>
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className={signupStyles.checkboxContainer}><input type='checkbox' id='remember' checked={rememberMe} onChange={(e) => setRememberMe(e.target.checked)}
            className={signupStyles.checkbox}
            />
            <label htmlFor='remember' className={signupStyles.checkboxLabel}>Remember Me
            </label>
              </div>       
              <button type='submit' className={`${signupStyles.button} ${
                isLoading ? signupStyles.buttonDisabled : ""}`} disabled = {isLoading}>
                  {isLoading ? (
                     <>
