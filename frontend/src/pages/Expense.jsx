        ...
        <FinancialCard
          icon={
            <div className={styles.iconOrange}>
              <span className={`w-5 h-5 ${styles.textOrange} flex items-center justify-center font-bold text-lg`}>
                ₹
              </span>
            </div>
          }
      ...
      <div className={styles.transactionsContainer}>
        <div className={styles.transactionsHeader}>
          <h3 className={styles.transactionsTitle}>
            <span className="w-6 h-6 -mx-1.5 lg:-mx-2 md:mx-0 text-orange-500 flex items-center justify-center font-bold text-lg">
              ₹
            </span>
          ...
          {filteredTransactions.length === 0 && (
            <div className={styles.emptyState}>
              <div className={styles.emptyStateIcon}>
                <span className="w-8 h-8 text-orange-400 flex items-center justify-center font-bold text-2xl">
                  ₹
                </span>
              </div>
...
//this is similer to the income page
