...
const JWT_SECRET = 'GANPATUNIVERSITY265985632';
...
export async function loginUser(req, res){
    ...
    if(!email || !password){
        return res.status(400).json({
            success: false,
            message: "Both fildes are required."
        })
    }
    try {
...
//     console.log("STATE:", mongoose.connection.readyState); // ✅ debug
